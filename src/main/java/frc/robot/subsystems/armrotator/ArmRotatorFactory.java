 ...
 * 
 */
public class ArmRotatorFactory {

   /** Our classes' logger **/
   private static final PKLogger logger = RioLogger.getLogger(ArmRotatorFactory.class.getName());

   /** Singleton instance of class for all to use **/
   private static IArmRotatorSubsystem ourInstance;
   /** Name of our subsystem **/
   private static final String myName = SubsystemNames.armRotatorName;
   ...
   public static synchronized void constructInstance() {
      SmartDashboard.putNumber(TelemetryNames.ArmRotator.status, PKStatus.inProgress.tlmValue);
   ...
   private static void loadImplementationClass(String myClassName) {
      String myPkgName = ArmRotatorFactory.class.getPackage().getName();
      ...
      try {
         ...
         ourInstance = (IArmRotatorSubsystem) myObject;
      ...
      SmartDashboard.putString(TelemetryNames.ArmRotator.implClass, ourInstance.getClass().getSimpleName());
   }
    ...
    **/
   public static IArmRotatorSubsystem getInstance() {
      if (ourInstance == null) {
