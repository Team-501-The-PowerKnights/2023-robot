...
public class IngesterFactory {
   ...
   /** Our classes' logger **/
   private static final Logger logger = PKLogger.getLogger(IngesterFactory.class.getName());

   /** Singleton instance of class for all to use **/
   private static IIngesterSubsystem ourInstance;
   /** Name of our subsystem **/
   private static final String myName = SubsystemNames.ingesterName;
   ...
   public static synchronized void constructInstance() {
      SmartDashboard.putNumber(TelemetryNames.Ingester.status, PKStatus.inProgress.tlmValue);
   ...
   private static void loadImplementationClass(String myClassName) {
      String myPkgName = IngesterFactory.class.getPackage().getName();
      ...
      try {
         ...
         ourInstance = (IIngesterSubsystem) myObject;
         SmartDashboard.putNumber(TelemetryNames.Ingester.status, PKStatus.success.tlmValue);
      } catch (ClassNotFoundException | InstantiationException | IllegalAccessException ex) {
         logger.error("failed to load class; instantiating default stub for: {}", myName);
         ProblemTracker.addError();
         ourInstance = new StubIngesterSubsystem();
         ourInstance.setDefaultCommand(new IngesterDoNothing());
         SmartDashboard.putNumber(TelemetryNames.Ingester.status, PKStatus.degraded.tlmValue);
      }
      SmartDashboard.putString(TelemetryNames.Ingester.implClass, ourInstance.getClass().getSimpleName());
   }
    ...
    **/
   public static IIngesterSubsystem getInstance() {
      if (ourInstance == null) {
