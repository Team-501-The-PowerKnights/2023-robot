...
public class ArmExtenderFactory {
   ...
   private static final String myName = SubsystemNames.armExtenderName;
   ...
   public static synchronized void constructInstance() {
      SmartDashboard.putNumber(TelemetryNames.ArmExtender.status, PKStatus.inProgress.tlmValue);
   ...
   private static void loadImplementationClass(String myClassName) {
      String myPkgName = ArmExtenderFactory.class.getPackage().getName();
      ...
      try {
         ...
         ourInstance = (IArmExtenderSubsystem) myObject;
      ...
      SmartDashboard.putString(TelemetryNames.ArmExtender.implClass, ourInstance.getClass().getSimpleName());
   }
    ...
    **/
   public static IArmExtenderSubsystem getInstance() {
      if (ourInstance == null) {
