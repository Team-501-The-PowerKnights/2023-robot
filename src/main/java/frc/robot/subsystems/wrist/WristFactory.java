...
public class WristFactory {
   ...
   private static final String myName = SubsystemNames.wristName;
   ...
   public static synchronized void constructInstance() {
      SmartDashboard.putNumber(TelemetryNames.Wrist.status, PKStatus.inProgress.tlmValue);
   ...
   private static void loadImplementationClass(String myClassName) {
      String myPkgName = WristFactory.class.getPackage().getName();
      ...
      try {
         ...
         ourInstance = (IWristSubsystem) myObject;
      ...
      SmartDashboard.putString(TelemetryNames.Wrist.implClass, ourInstance.getClass().getSimpleName());
   }
    ...
    **/
   public static IWristSubsystem getInstance() {
      if (ourInstance == null) {
